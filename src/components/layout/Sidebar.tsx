        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-xl tracking-tight bg-gradient-to-r from-[var(--color-brand-cyan)] via-[var(--color-brand-blue)] to-[var(--color-brand-purple)] text-transparent bg-clip-text leading-none">
                ORKESTRIA
              </span>
