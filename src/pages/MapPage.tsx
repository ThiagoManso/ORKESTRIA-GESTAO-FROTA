    ...
    <div className="flex flex-col h-full bg-white">
      <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-white shadow-sm z-10 relative">
        ...
        <div className="flex gap-2 items-center text-sm font-medium overflow-x-auto pb-1 sm:pb-0">
          <button 
            onClick={() => { setFilter('all'); setSelectedRoute(null); }}
          ...
          <button 
            onClick={() => { setFilter('unassigned'); setSelectedRoute(null); }}
          ...
          <button 
            onClick={() => { setFilter('assigned'); setSelectedRoute(null); }}
          ...
          <button 
            onClick={() => { setFilter('completed'); setSelectedRoute(null); }}
